# Agent Framework Toolkit @ GitHub

> This package is aimed at GitHub as an LLM Provider. Check out the [General README.md](https://github.com/rwjdk/AgentFrameworkToolkit/blob/main/README.md) for other providers and shared features in Agent Framework Toolkit.
...
1. Install the 'AgentFrameworkToolkit.GitHub' NuGet Package (`dotnet add package AgentFrameworkToolkit.GitHub`)
2. Get your [GitHub API Key](https://github.com/settings/personal-access-tokens)
3. Create an `GitHubAgentFactory` instance (Namespace: AgentFrameworkToolkit.GitHub)
4. Use instance to create your `GitHubAgent` (which is a regular Microsoft Agent Framework `AIAgent` behind the scenes)

### Minimal Code Example
```cs
//Create your AgentFactory
GitHubAgentFactory agentFactory = new GitHubAgentFactory("<Access Token>");
...
//Create your Agent
GitHubAgent agent = agentFactory.CreateAgent(new GitHubAgentOptions //Use GitHubAgentOptions overload to access more options
{
    Model = "openai/gpt-5",
