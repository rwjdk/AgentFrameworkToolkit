...
public static class WeatherTools
{
    ...
    public static AITool GetWeatherForCity(OpenWeatherMapOptions options, string? toolName = "get_weather_for_city", string? toolDescription = "Get weather for specified city. If country is needed to specify same name cities the define as <city>,<country_code>")
    {
